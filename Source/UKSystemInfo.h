...
NSUInteger	UKPhysicalRAMSize();						// RAM Size in MBs.
NSString*	UKSystemVersionString();					// System version as a string MM.m.b
NSUInteger	UKClockSpeed();								// CPU speed in MHz.
NSUInteger	UKCountCores();								// Number of CPU cores. This is always >= number of CPUs.
