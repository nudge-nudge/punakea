...
- (id)initWithCoder:(NSCoder *)coder
  ...
  [self setBlendingMode:[coder decodeIntegerForKey:@"CTGradientBlendingMode"]];
...
- (CTGradient *)removeColorStopAtIndex:(NSUInteger)idx  {
  CTGradient *newGradient = [self copy];
...
- (NSColor *)colorStopAtIndex:(NSUInteger)idx  {
...
- (CTGradientElement)removeElementAtIndex:(NSUInteger)idx  {
...
- (CTGradientElement *)elementAtIndex:(NSUInteger)idx;			
  {
  NSUInteger count = 0;
  CTGradientElement *currentElement = elementList;
